...
import { objectagiDark } from '@objectagi/colors';
...
/**
 * The defaultSettings object defines the default settings for the ObjectAGI application.
 */
...
/**
 * The getParsedQuerySettings function parses the query string to retrieve the default settings for the ObjectAGI application.
 * It returns a ObjectAGISettingsConfigType object that can be used to configure the application.
 */
export function getParsedQuerySettings(): ObjectAGISettingsConfigType | object {
	...
	if (typeof defaultSettings === 'string') {
		...
		return JSON.parse(defaultSettings) as ObjectAGISettingsConfigType;
	}
...
export const defaultThemeOptions = {
	typography: {
		fontFamily: ['Roboto Flex', 'Roboto', 'Inter var', 'Arial', 'sans-serif'].join(','),
		fontWeightLight: 400,
