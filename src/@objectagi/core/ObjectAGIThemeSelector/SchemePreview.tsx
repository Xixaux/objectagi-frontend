...
type SchemePreviewProps = {
	id: string;
	className?: string;
	onSelect: (T: ObjectAGIThemeType) => void;
	theme: ObjectAGIThemeType;
};
...
function SchemePreview(props: SchemePreviewProps) {
	...
	const primaryColor: string = theme.palette.primary[500] ? theme.palette.primary[500] : theme.palette.secondary.main;
