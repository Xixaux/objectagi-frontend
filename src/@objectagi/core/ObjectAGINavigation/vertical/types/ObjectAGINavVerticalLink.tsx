...
/**
 * ObjectAGINavVerticalLink
 * Create a vertical Link to use inside the navigation component.
 */
function ObjectAGINavVerticalLink(props: ObjectAGINavItemComponentProps) {
		...
		() => (
			...
			>
				...
				<ListItemText
					...
					classes={{
						primary: 'text-md font-medium objectagi-list-item-text-primary truncate',
						secondary: 'text-sm font-medium objectagi-list-item-text-secondary leading-[1.5] truncate'
					}}
				/>
...
const NavVerticalLink = ObjectAGINavVerticalLink;
