...
type ObjectAGINavHorizontalGroupProps = ObjectAGINavItemComponentProps & WithRouterProps;

/**
 * ObjectAGINavHorizontalGroup.
 * Represents a horizontal group component used in the ObjectAGI navigation navigation list.
 * It shows the list item as well as its children with a flyout effect.
 */
function ObjectAGINavHorizontalGroup(props: ObjectAGINavHorizontalGroupProps) {
...
const NavHorizontalGroupWithMemo = memo(ObjectAGINavHorizontalGroup);
