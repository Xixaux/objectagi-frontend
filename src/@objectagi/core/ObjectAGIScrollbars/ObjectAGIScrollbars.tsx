...
export type ObjectAGIScrollbarsProps = {
	id?: string;
	className?: string;
	children?: ReactNode;
	enable?: boolean;
...
function ObjectAGIScrollbars(props: ObjectAGIScrollbarsProps) {
	const {
		className = '',
		children,
		id = '',
	...
	const hookUpEvents = useCallback(() => {
		Object.keys(handlerNameByEvent).forEach((key) => {
			const callback = props[handlerNameByEvent[key] as keyof ObjectAGIScrollbarsProps] as (T: HTMLDivElement) => void;
...
export default ObjectAGIScrollbars;
