...
import { ObjectAGIThemeType } from '../ObjectAGISettings';
...
type PaletteSelectorProps = {
	...
	value: ObjectAGIThemeType;
	onChange: (value: ObjectAGIThemeType) => void;
};
...
function PaletteSelector(props: PaletteSelectorProps) {
	...
	const methods = useForm<ObjectAGIThemeType>({
		defaultValues: {},
		mode: 'onChange'
	});
	...
	function onSubmit(formData: ObjectAGIThemeType) {
		onChange(formData);
		handleCloseDialog();
	}
