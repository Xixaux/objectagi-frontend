...
import { ObjectAGIFlatNavItemType } from '../ObjectAGINavigation/types/ObjectAGINavItemType';

const Root = styled('div')(({ theme }) => ({
    '& .ObjectAGISearch-container': {
        position: 'relative'
    },
    '& .ObjectAGISearch-suggestionsContainerOpen': {
        position: 'absolute',
        zIndex: 1,
    ...
    '& .ObjectAGISearch-suggestion': {
        display: 'block'
    },
    '& .ObjectAGISearch-suggestionsList': {
        margin: 0,
        padding: 0,
        listStyleType: 'none'
    },
    '& .ObjectAGISearch-input': {
            ...
            {variant === 'basic' ? (
                ...
                <>
                    <TextField
                        ...
                        InputProps={{
                            ...
                            classes: {
                                input: 'ObjectAGISearch-input py-0 px-4 h-9 md:h-9 ltr:pr-9 rtl:pl-9',
                ...
                <TextField
                    ...
                    InputProps={{
                        ...
                        classes: {
                            input: 'ObjectAGISearch-input py-0 px-4 h-9'
                        }
                    }}
                    variant="standard"
                    {...other}
...
function renderSuggestion(suggestion: ObjectAGIFlatNavItemType, { query, isHighlighted }: RenderSuggestionParams) {
    ...
    return (
        ...
        >
            <ListItemIcon className="min-w-9">
                {suggestion.icon ? (
                    <ObjectAGISvgIcon>{suggestion.icon}</ObjectAGISvgIcon>
                ) : (
...
function getSuggestions(value: string, data: ObjectAGIFlatNavItemType[]): ObjectAGIFlatNavItemType[] {
...
function getSuggestionValue(suggestion: ObjectAGIFlatNavItemType) {
...
type StateType = {
    ...
    suggestions: ObjectAGIFlatNavItemType[];
...
type ActionType =
    ...
    | { type: 'setNavigation'; data: ObjectAGIFlatNavItemType[] }
...
/**
 * Props for ObjectAGISearch component
 */
type ObjectAGISearchProps = {
    className?: string;
    navigation: ObjectAGIFlatNavItemType[];
    variant?: 'basic' | 'full';
    trigger?: ReactNode;
...
/**
 * ObjectAGISearch component
 */
function ObjectAGISearch(props: ObjectAGISearchProps) {
    const {
        navigation = [],
        className,
        variant = 'full',
        ...
        // BORDER REMOVED: Deleted the 'border border-divider' utility classes here.
        trigger = (
            <IconButton> 
                <ObjectAGISvgIcon size={20}>heroicons-outline:magnifying-glass</ObjectAGISvgIcon>
            </IconButton>
        )
    } = props;
    ...
    function handleSuggestionSelected(
        ...
        { suggestion }: { suggestion: ObjectAGIFlatNavItemType }
    ) {
                ...
                >
                    <Autosuggest
                        ...
                        theme={{
                            ...
                            suggestionsList: 'ObjectAGISearch-suggestionsList',
                            suggestion: 'ObjectAGISearch-suggestion'
                        }}
...
export default memo(ObjectAGISearch);