...
const Root = styled('div')(({ theme }) => ({
  backgroundColor: theme.palette.mode === 'light' ? theme.palette.background.paper : '#FAFAFA',
...
const StyledContent = styled(ObjectAGIScrollbars)(({ theme }) => ({
  backgroundColor: theme.palette.mode === 'light' ? theme.palette.background.paper : '#FAFAFA',
  overscrollBehavior: 'contain',
  overflowX: 'hidden',
  overflowY: 'auto',
  WebkitOverflowScrolling: 'touch', // Fixed: removed double colon
