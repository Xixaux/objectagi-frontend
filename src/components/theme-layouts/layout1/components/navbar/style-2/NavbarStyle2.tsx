		...
		},
		{
			...
			style: {
				'& .NavbarStyle2-content': {
					...
					'& .objectagi-list-item-text, & .arrow-icon, & .item-badge': {
						opacity: 0
					},
					'& .objectagi-list-subheader .objectagi-list-subheader-text': {
						opacity: 0
					},
					'& .objectagi-list-subheader:before': {
						content: '""',
						display: 'block',
						position: 'absolute',
						minWidth: 16,
...
function NavbarStyle2() {
	...
	const settings = useObjectAGILayoutSettings();
