            ...
            >
                ...
                <div className="flex flex-col flex-auto space-y-2">
                    <Typography
                        ...
                        sx={{ color: '#333' }} // Hardcoded dark color
                    >
                        {user?.displayName}
                    </Typography>
                    <Typography
            ...
            >
                {isGuest ? (
                    <>
                        ...
                        >
                            <ListItemIcon className="min-w-9">
                                <ObjectAGISvgIcon>heroicons-outline:lock-closed</ObjectAGISvgIcon>
                            </ListItemIcon>
                        ...
                        >
                            <ListItemIcon className="min-w-9">
                                <ObjectAGISvgIcon>heroicons-outline:user-plus</ObjectAGISvgIcon>
                            </ListItemIcon>
                    ...
                    <>
                        ...
                        >
                            <ListItemIcon className="min-w-9">
                                <ObjectAGISvgIcon>heroicons-outline:user-circle</ObjectAGISvgIcon>
                            </ListItemIcon>
                        ...
                        >
                            <ListItemIcon className="min-w-9">
                                <ObjectAGISvgIcon>heroicons-outline:arrow-right-on-rectangle</ObjectAGISvgIcon>
                            </ListItemIcon>
