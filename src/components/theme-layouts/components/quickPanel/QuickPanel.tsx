				...
				<List>
					...
					<ListItem>
						<ListItemIcon className="min-w-9">
							<ObjectAGISvgIcon>material-outline:notifications</ObjectAGISvgIcon>
						</ListItemIcon>
					...
					<ListItem>
						<ListItemIcon className="min-w-9">
							<ObjectAGISvgIcon>material-outline:cloud</ObjectAGISvgIcon>
						</ListItemIcon>
					...
					<ListItem>
						<ListItemIcon className="min-w-9">
							<ObjectAGISvgIcon>material-outline:brightness_high</ObjectAGISvgIcon>
						</ListItemIcon>
